...
const labelDelta = (ud) => (d, i, v) => hyperbolic_math_2.CaddC(nodeRadiusOffset(ud)(d), d3updatePattern_1.bboxCenter(d, 'labellen-bg', d.layoutReference.zp || hyperbolic_math_1.CktoCp(d.layout.z)));
