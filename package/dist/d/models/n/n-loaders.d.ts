import { N } from './n';
export declare type LoaderFunction = (ok: (root: N, t0: number, dl: number) => void) => void;
export declare var path_: (len: any) => (ok: any) => void;
export declare var star_: (degree: any) => (ok: any) => void;
export declare var fromFile: (f: any) => (ok: any) => void;
export declare var fromData: (f: any) => (ok: any) => void;
export declare var fromLangFile: (f: any) => (ok: any) => void;
